        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">                    
                    ...
                    <em><a href="index.php?action=post&id=<?= urlencode($post->identifier) ?>"><p class="alert alert-primary">Lire la suite →</p></a></em> 
                    <?php } ?>                        
                    <!-- Divider-->
                    <hr class="my-4" />                    
                    <?php } ?>
                    <?php if(!isset($_SESSION['id'])) { ?>
                    <em><a href="index.php?action=login"><p class="alert alert-primary">Connectez-vous pour acceder aux posts !</p></a></em>
                    <?php } ?>                       
